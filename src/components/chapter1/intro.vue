<template>
  <div class="chapterIntro">
    <img src="/static/img/drone/drone1.jpg" alt="#" class="chapterIntro--bg">
  ...
  <h1 class="chapterIntro--title">POURQUOI LES DRONES</h1>
  <div class="chapterIntro--border"></div>
  <p class="chapterIntro--txt">les Drones ont révolutionné le monde de l'aviation militaire. Peu onéreux et plus efficients qu'un avion classique, ils les replacent. Cette évolution s'accompagne-t-elle d'un changement de mentalité ?</p>
...
export default {
  ...
  mounted: function () {
    ...
    const Scrolling = new ScrollingEvent('.chapterIntro', '/chapitre1/le-drone', '/', 500)
    setTimeout(function ()
    {
      Scrolling.goTo();
    }, 1500)
